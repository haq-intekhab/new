...
const OfferAndEvents = () => {
  ...
  function closePopup() {
    console.log("inside closePopup");
    // document.getElementById("restaurant").style.display = "hidden";
  ...
  return (
    <div id="offer" className="w-full h-fit relative ">
      ...
      <motion.div
        ...
        className="sm:w-[500px]  w-full h-[750px] sm:left-[30%] fixed bg-[#FFFFFF] hidden  z-[1200] mt-[80px] rounded-2xl sm:p-4 p-4 "
      >
