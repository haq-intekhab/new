  ...
  return (
    <div id="payment" className="w-full h-fit relative ">
      ...
      <motion.div
        ...
        className="sm:w-[500px]  w-full h-fit  sm:left-[30%] fixed bg-[#FFFFFF] hidden  z-[1200] mt-[80px] rounded-2xl sm:p-4 p-4 "
      >
      ...
      <div className="w-full h-fit  mt-[10px] px-6   ">
        <div className="bg-white  flex flex-col gap-6 sm:py-5 py-2 rounded-lg ">
          ...
          <div className="bg-[#e6edfcf2] flex gap-4 w-full justify-center  sm:justify-start px-[1.5rem] border-b p-6">
            <button
              id="w"
              className="border sm:px-5 px-4 py-2 border-[#e2eafc] rounded-full bg-[#004AAD] text-white text-nowrap"
              onClick={trans}
            >
              All Transactions
            </button>
