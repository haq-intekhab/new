...
const Dashboard = () => {
    ...
    return (
        <div id='dashboard' className='w-full h-fit relative'>
            ...
            {/* QR code popup */}
            <motion.div id="popup" whileInView={{ y: [400, 0] }} transition={{ duration: .5, type: "tween" }} className='sm:w-[500px]  w-[100%] sm:h-[500px] h-[650px]    sm:left-[30%] fixed bg-[#FFFFFF] hidden  z-[1200] mt-[80px] rounded-2xl sm:p-4 p-4  '>
